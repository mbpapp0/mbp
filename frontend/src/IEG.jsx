...
export default function IEG() {
  ...
  const handleSubmit = (e) => {
    ...
    return(
    <div>
      <h6 className="center">{branchName} Branch.</h6>
      <h6 className="center">CACFP Meal Benefit Income Eligibility Statement*</h6>
  <form className="printout">
...
<tr>
  <td colSpan={7}>
    ...
    <div>
      Last four Digits of Social Security Number XXX-X <span><input type="number" className="underline_input ssn_input" value={data.ssn}/></span> <span><input type="checkbox" className="ssn_checkbox" check={data.noSSN ? true : false} />I do not have a Social Security Number</span>
    </div>
  </td>
</tr>
