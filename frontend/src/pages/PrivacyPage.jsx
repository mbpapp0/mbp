    ...
    return(
        <main className="info_page">
            <section className="info_section">
                <h2 className="info_title">Privacy Policy</h2>
                <p className="info_description">


Sawwam has replaced the AdChoice program with Digital Advertising Alliance of Canada’s AdChoices. You may have previously opted-out of advertising personalization on sawwam through the AdChoice program. If you wish to continue opting-out of advertising personalization please see Section 5.
...
1. General
This privacy policy describes the policy of sawwam Canada regarding the collection, use, storage, sharing and protection of your personal information (“Privacy Policy”). This Privacy Policy applies to the sawwam.com and  websites (together, “sawwam” or “Website”) and all related websites, applications, services and tools where reference is made to this policy (“Services”), regardless of how you access the Services, including access through mobile devices. sawwam Canada Ltd. is the data controller.

Scope and consent: By using sawwam and related Services, you give explicit consent to sawwam for the collection, use, disclosure and retention of your personal information by us, as described in this Privacy Policy and our Terms of Use.

sawwam may change this Privacy Policy from time to time. We advise you to read it regularly. Substantial changes to our Privacy Policy will be announced on our Website. The amended Privacy Policy will be effective immediately after it is first posted on our Website. This Privacy Policy is effective as of January 1, 2017.
...
to contact you, by e-mail, push notification, text message (SMS) or by telephone, to inquire about our Services and the services of companies that are part of the sawwam Canada Ltd. “corporate family’ (see www.ebayclassifiedsgroup.com) (hereinafter referred to as the ‘Classifieds Group’) for the purpose of targeted marketing activities, updates, and promotional offers based on your message preferences (where applicable), or for any other purposes as set forth in this Privacy Policy;
...
service providers with whom we have entered into an agreement to help us provide our Services on the website, such as financial service providers, marketing agencies and technical support. In such cases, the personal information shall remain under the control of sawwam Canada Ltd. If you are listing an ad, your listing or business address may be displayed on a map in your ads (including within the sawwam mobile application) via Google Maps and therefore transferred to Google (refer to the Google Privacy Notice for more info).
...
other third parties to whom you have given consent to share your information via sawwam, e.g. in the framework of a cooperation;
...
You agree that we may use the information collected by us to send you offers, whether personalized or not, or to contact you by telephone regarding products or Services offered by sawwam or companies of the Classifieds Group.
...
When you no longer wish to receive marketing communications from us, you can, where applicable, change your preferences in your My sawwam account, or follow the unsubscribe link in the marketing communication you received.

5. Advertising
sawwam adheres to the Digital Advertising Alliance of Canada’s (DAAC) AdChoices program principles. If you do not wish to participate in our advertising personalization using your personal information or retargeting/tracking programs, you can opt-out by following the directions provided within the applicable advertisement, or directly at the AdChoices website provided by the DAAC, and use the opt-out mechanism. This does not necessarily mean that no advertisements will be shown to you. It simply means that these advertisements will not be personalized for you by means of cookies, web beacons or similar technologies.
...
We cannot modify your personal information or account information. You can modify your own information by logging into your sawwam account. When you place a classified ad, you may not be able to change your listing or delete your message. If you want to close your account (where applicable) with us, please send us a request to us here. We will process your request within a reasonable period of time and process your personal information in accordance with applicable law. Alternatively, you can also contact Customer Support to access your personal information stored by us that is not directly accessible on sawwam, unless we are not required to provide access under applicable law. We may charge a fee to compensate costs; however the fee shall not exceed the amount permitted by law. If your information is factually incorrect or incomplete or irrelevant for the purposes for which we process your information, you can request us to modify or delete your information. Such requests will be handled in accordance with applicable law. If you have any questions, please contact us with the subject line ‘Request Privacy Policy’:

– via the Contact Form; or

– by writing to sawwam Canada Ltd. Attention: sawwam Canada Customer Support, 500 King St. W., Suite 200, Toronto, Ontario M5V 1L9.
